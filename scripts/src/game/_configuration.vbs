...
Const MeteorCoolColor = "ffeede"
Const MeteorWarmColor = "ffc400"
...
MainShotNames = Array("left_side","left_orbit","left_ramp","inner_orbit","center_orbit","right_ramp","right_orbit")
' MainShotLightNames = Array("LS1","LS2","LS3","LS4","LPC4","LPC5","LS5","LS6")
MainShotLightNames = Array("LS1","LS2","LS3","LS4","LPC45","LS5","LS6")
...
Sub ConfigureGlfDevices
   ...
   '*********** DEVICE CONFIGS ***********
    ...
    With CreateGlfFlipper("left")
        ...
        .DisableEvents = Array("kill_flippers","mode_eob_bonus_started")
    ...
    With CreateGlfDiverter("lock_pin_game_over")
        ...
        .ActivateEvents = Array("game_ended{device.ball_devices.moon_lock.balls > 0}")
        .ActivationTime = "3000"
        .ActionCallback = "DropLockPin"
        .ExcludeFromBallSearch = True
    End With
