...
Sub CreateFinalWaveWizardMode
    ...
    With CreateGlfMode("final_wave_wizard", 4000)
        ...
        With .EventPlayer()
            ...
            '  explosion flippers
            .Add "timer_asteroid_explodes_tick{device.timers.asteroid_explodes.ticks == 4}", Array("kill_flippers")
            .Add "timer_asteroid_explodes_complete", Array("enable_flippers","explosion_done")

            'handle GI light show
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 1}", Array("play_flash_gi09","play_flash_giapron")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 2}", Array("play_flash_gi06","play_flash_gi11","play_flash_gi21","play_flash_gi22","play_flash_gi12","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 3}", Array("play_flash_gi03","play_flash_gi10","play_flash_gi18","play_flash_gi16")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 4}", Array("play_flash_gi08","play_flash_gi19","play_flash_gi20")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 5}", Array("play_flash_gi05","play_flash_gi09","play_flash_gi21","play_flash_gi13","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 6}", Array("play_flash_gi02","play_flash_gi22","play_flash_gi16","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 7}", Array("play_flash_gi07","play_flash_gi11","play_flash_gi15")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 8}", Array("play_flash_gi04","play_flash_gi10","play_flash_gi18","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 9}", Array("play_flash_gi01","play_flash_gi19","play_flash_gi20","play_flash_giapron")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 10}", Array("play_flash_gi06","play_flash_gi21","play_flash_gi13","play_flash_gi12")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 11}", Array("play_flash_gi03","play_flash_gi09","play_flash_gi22","play_flash_gi16","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 12}", Array("play_flash_gi08","play_flash_gi11","play_flash_gi17","play_flash_gi15")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 13}", Array("play_flash_gi05","play_flash_gi10","play_flash_gi18","play_flash_gi13")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 14}", Array("play_flash_gi02","play_flash_gi20","play_flash_gi22","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 15}", Array("play_flash_gi07","play_flash_gi21","play_flash_gi15")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 16}", Array("play_flash_gi04","play_flash_gi09","play_flash_gi16")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 17}", Array("play_flash_gi01","play_flash_gi11","play_flash_giapron")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 18}", Array("play_flash_gi06","play_flash_gi19","play_flash_gi18","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 19}", Array("play_flash_gi03","play_flash_gi20","play_flash_gi13")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 20}", Array("play_flash_gi09","play_flash_gi08","play_flash_gi21","play_flash_gi22","play_flash_gi12")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 21}", Array("play_flash_gi05","play_flash_gi11","play_flash_gi16","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 22}", Array("play_flash_gi02","play_flash_gi10","play_flash_gi18","play_flash_gi15")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 23}", Array("play_flash_gi07","play_flash_gi19","play_flash_gi20","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 24}", Array("play_flash_gi04","play_flash_gi09","play_flash_gi21","play_flash_gi13")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 25}", Array("play_flash_gi01","play_flash_gi11","play_flash_gi22","play_flash_gi16","play_flash_gi14","play_flash_giapron")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 26}", Array("play_flash_gi06","play_flash_gi10","play_flash_gi18","play_flash_gi15")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 27}", Array("play_flash_gi03","play_flash_gi19","play_flash_gi20","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 28}", Array("play_flash_gi08","play_flash_gi13")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 29}", Array("play_flash_gi09","play_flash_gi05","play_flash_gi21","play_flash_gi22","play_flash_gi12")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 30}", Array("play_flash_gi02","play_flash_gi10","play_flash_gi11","play_flash_gi16","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 31}", Array("play_flash_gi07","play_flash_gi18","play_flash_gi13")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 32}", Array("play_flash_gi04","play_flash_gi19","play_flash_gi20","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 33}", Array("play_flash_gi01","play_flash_gi09","play_flash_gi21","play_flash_gi22","play_flash_giapron")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 34}", Array("play_flash_gi06","play_flash_gi10","play_flash_gi11","play_flash_gi16")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 35}", Array("play_flash_gi03","play_flash_gi19","play_flash_gi18","play_flash_gi15")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 36}", Array("play_flash_gi08","play_flash_gi20","play_flash_gi13","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 37}", Array("play_flash_gi05","play_flash_gi21","play_flash_gi22","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 38}", Array("play_flash_gi02","play_flash_gi10","play_flash_gi18","play_flash_gi16","play_flash_gi15")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 39}", Array("play_flash_gi07","play_flash_gi20","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 40}", Array("play_flash_gi09","play_flash_gi19","play_flash_gi21","play_flash_gi12")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 41}", Array("play_flash_gi04","play_flash_gi11","play_flash_gi13","play_flash_gi22","play_flash_giapron")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 42}", Array("play_flash_gi01","play_flash_gi10","play_flash_gi18","play_flash_gi16","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 43}", Array("play_flash_gi06","play_flash_gi20","play_flash_gi17","play_flash_gi15")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 44}", Array("play_flash_gi03","play_flash_gi09")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 45}", Array("play_flash_gi08","play_flash_gi11","play_flash_gi19","play_flash_gi21")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 46}", Array("play_flash_gi05","play_flash_gi10","play_flash_gi13","play_flash_gi16")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 47}", Array("play_flash_gi02","play_flash_gi18","play_flash_gi22","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 48}", Array("play_flash_gi07","play_flash_gi20","play_flash_gi17")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 49}", Array("play_flash_gi09","play_flash_gi19","play_flash_gi21","play_flash_gi12")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 50}", Array("play_flash_gi04","play_flash_gi11","play_flash_gi13","play_flash_gi22","play_flash_giapron")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 51}", Array("play_flash_gi01","play_flash_gi10","play_flash_gi18","play_flash_gi16","play_flash_gi14")
            .Add "timer_final_wave_gi_tick{device.timers.final_wave_gi.ticks == 52}", Array("play_flash_gi06","play_flash_gi20","play_flash_gi17","play_flash_gi15")

            'handle asteroid flicker show
            .Add "timer_final_wave_flicker_tick{device.timers.final_wave_flicker.ticks == 1}", Array("play_asteroid_flicker")
            .Add "timer_final_wave_flicker_tick{device.timers.final_wave_flicker.ticks == 7}", Array("play_asteroid_flicker")
            .Add "timer_final_wave_flicker_tick{device.timers.final_wave_flicker.ticks == 10}", Array("play_asteroid_flicker")
            .Add "timer_final_wave_flicker_tick{device.timers.final_wave_flicker.ticks == 15}", Array("play_asteroid_flicker")
            .Add "timer_final_wave_flicker_tick{device.timers.final_wave_flicker.ticks == 22}", Array("play_asteroid_flicker")
        ...
        With .Shots("asteroid")
            .Profile = "asteroid"
            With .ControlEvents()
                .Events = Array("timer_final_wave_message_tick{device.timers.final_wave_message.ticks == 2}","continue_fwwiz")
                .State = 1
            End With
