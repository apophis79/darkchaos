...
Sub CreateTrainingProtonCannonMode
    ...
    With CreateGlfMode("training_proton_cannon",700)
        ...
        With .EventPlayer()
            ...
            'successfull shot
            .Add "inner_orbit_hit{current_player.shot_training_proton_charge1 == 0}", Array("light_proton_charge1","flash_gi","play_sfx_LS","score_5000")
            .Add "inner_orbit_hit{current_player.shot_training_proton_charge1 == 1 && current_player.shot_training_proton_charge2 == 0}", Array("light_proton_charge2","flash_gi","play_sfx_LS","score_5000")
            .Add "inner_orbit_hit{current_player.shot_training_proton_charge2 == 1 && current_player.shot_training_proton_charge3 == 0}", Array("light_proton_charge3","play_sfx_LS","score_5000") ',"flash_gi")
