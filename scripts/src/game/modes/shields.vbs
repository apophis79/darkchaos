...
Sub CreateShieldsMode
    ...
    With CreateGlfMode("shields", 510)
        ...
        With .EventPlayer()
            ...
            'show
            .Add "qualify_shields_on_complete", Array("slings_powerup_added","lsling_powerup_sh","rsling_powerup_sh","play_shields_up","score_10000")
            .Add "qualify_shields_hit", Array("score_500")
        End With
