...
Sub CreatePostGameMode()
    ...
    With CreateGlfMode("post_game", 180)
        ...
        With .EventPlayer()
            .Add "mode_post_game_started", Array("select_message_num","meteor1_knockdown","meteor2_knockdown","meteor3_knockdown","meteor4_knockdown","backglass_dark_on","backglass_chaos_on")
            ...
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 1}", Array("display_last_scores")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 2}", Array("play_spotlight_on")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 4}", Array("play_flasher1_flash_3000k","play_flasher2_flash_3000k","play_flasher3_flash_3000k","play_asteroid_hit")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 5}", Array("")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 6}", Array("")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 7}", Array("")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 8}", Array("check_loser_message","check_winner_message1","play_flasher1_flash_3000k","play_flasher2_flash_3000k","play_flasher3_flash_3000k","play_asteroid_hit")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 9}", Array("")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 10}", Array("play_spotlight_off")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 11}", Array("")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 12}", Array("play_earth_hit_center2")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 13}", Array("")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 14}", Array("")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 15}", Array("")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 16}", Array("display_last_scores","play_flasher1_flash_3000k","play_flasher2_flash_3000k","play_flasher3_flash_3000k","play_asteroid_hit")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 17}", Array("play_slide_left")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 18}", Array("play_slide_up","play_spotlight_on")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 19}", Array("play_slide_right")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 20}", Array("play_slide_down6")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 21}", Array("")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 22}", Array("")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 23}", Array("")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 24}", Array("powerup_training","check_loser_message","check_winner_message2","play_meteor_wave_fall","play_flash_gi01","play_flash_gi09","play_flash_giapron","play_meteors_sweep")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 25}", Array("powerup_cluster","play_flash_gi06","play_flash_gi11","play_flash_gi21","play_flash_gi22","play_flash_gi12","play_flash_gi14")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 26}", Array("powerup_moon","play_flash_gi03","play_flash_gi10","play_flash_gi18","play_flash_gi16")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 27}", Array("powerup_proton","play_flash_gi08","play_flash_gi19","play_flash_gi20","play_spotlight_off")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 28}", Array("powerup_shields","play_flash_gi05","play_flash_gi09","play_flash_gi21","play_flash_gi13","play_flash_gi17")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 29}", Array("powerup_timewarp","play_flash_gi02","play_flash_gi22","play_flash_gi16","play_flash_gi14","play_spotlight_on")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 30}", Array("powerup_saver","play_flash_gi07","play_flash_gi11","play_flash_gi15")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 31}", Array("powerup_health","play_flash_gi04","play_flash_gi10","play_flash_gi18","play_flash_gi17")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 32}", Array("powerup_combos","display_last_scores","play_flash_gi01","play_flash_gi19","play_flash_gi20","play_flash_giapron")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 33}", Array("powerup_training","play_flash_gi06","play_flash_gi21","play_flash_gi13","play_flash_gi12")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 34}", Array("powerup_cluster","play_flash_gi03","play_flash_gi09","play_flash_gi22","play_flash_gi16","play_flash_gi14")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 35}", Array("powerup_moon","play_flash_gi08","play_flash_gi11","play_flash_gi17","play_flash_gi15")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 36}", Array("powerup_proton","play_flash_gi05","play_flash_gi10","play_flash_gi18","play_flash_gi13")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 37}", Array("powerup_shields","play_flash_gi02","play_flash_gi20","play_flash_gi22","play_flash_gi14","play_spotlight_off")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 38}", Array("powerup_timewarp","play_flash_gi07","play_flash_gi21","play_flash_gi15")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 39}", Array("powerup_saver","play_flash_gi04","play_flash_gi09","play_flash_gi16","play_spotlight_on")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 40}", Array("powerup_health","check_loser_message","check_winner_message3","play_flash_gi01","play_flash_gi11","play_flash_giapron")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 41}", Array("powerup_combos","play_flash_gi06","play_flash_gi19","play_flash_gi18","play_flash_gi17")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 42}", Array("powerup_training","play_flash_gi03","play_flash_gi20","play_flash_gi13")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 43}", Array("powerup_cluster","play_flash_gi09","play_flash_gi08","play_flash_gi21","play_flash_gi22","play_flash_gi12")
            ...
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 51}", Array("powerup_training","play_flash_gi08","play_flash_gi13","play_flasher3_flash_hot")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 52}", Array("powerup_cluster","play_slide_down6","play_flash_gi09","play_flash_gi05","play_flash_gi21","play_flash_gi22","play_flash_gi12","play_flasher1_flash_magenta")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 53}", Array("powerup_moon","play_flash_gi02","play_flash_gi10","play_flash_gi11","play_flash_gi16","play_flash_gi14","play_flasher2_flash_yellow")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 54}", Array("powerup_proton","play_flash_gi07","play_flash_gi18","play_flash_gi13","play_flasher3_flash_cyan")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 55}", Array("powerup_shields","play_flash_gi04","play_flash_gi19","play_flash_gi20","play_flash_gi17","play_flasher2_flash_blue")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 56}", Array("powerup_timewarp","check_loser_message","check_winner_message4","play_flash_gi01","play_flash_gi09","play_flash_gi21","play_flash_gi22","play_flash_giapron","play_flasher1_flash_white")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 57}", Array("powerup_saver","play_flash_gi06","play_flash_gi10","play_flash_gi11","play_flash_gi16","play_flasher2_flash_purple","play_spotlight_off")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 58}", Array("powerup_health","play_flash_gi03","play_flash_gi19","play_flash_gi18","play_flash_gi15","play_flasher3_flash_green","play_spotlight_on")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 59}", Array("powerup_combos","play_flash_gi08","play_flash_gi20","play_flash_gi13","play_flash_gi17","play_flasher2_flash_white")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 60}", Array("powerup_training","play_flash_gi05","play_flash_gi21","play_flash_gi22","play_flash_gi14","play_flasher3_flash_hot")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 61}", Array("powerup_cluster","play_flash_gi02","play_flash_gi10","play_flash_gi18","play_flash_gi16","play_flash_gi15","play_flasher1_flash_magenta","play_lsling_magenta")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 62}", Array("powerup_moon","play_flash_gi07","play_flash_gi20","play_flash_gi17","play_flasher2_flash_yellow","play_rsling_yellow")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 63}", Array("powerup_proton","play_flash_gi09","play_flash_gi19","play_flash_gi21","play_flash_gi12","play_flasher3_flash_cyan","play_lsling_cyan")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 64}", Array("powerup_shields","display_last_scores","play_flash_gi04","play_flash_gi11","play_flash_gi13","play_flash_gi22","play_flash_giapron","play_flasher2_flash_blue","play_rsling_blue")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 65}", Array("powerup_timewarp","play_flash_gi01","play_flash_gi10","play_flash_gi18","play_flash_gi16","play_flash_gi14","play_flasher1_flash_white","play_lsling_white")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 66}", Array("powerup_saver","play_flash_gi06","play_flash_gi20","play_flash_gi17","play_flash_gi15","play_flasher2_flash_purple","play_rsling_purple","play_spotlight_off")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 67}", Array("powerup_health","play_flash_gi03","play_flash_gi09","play_flasher3_flash_green","play_lsling_green")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 68}", Array("powerup_combos","play_flash_gi08","play_flash_gi11","play_flash_gi19","play_flash_gi21","play_flasher2_flash_white","play_rsling_white","play_spotlight_on")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 69}", Array("powerup_training","play_flash_gi05","play_flash_gi10","play_flash_gi13","play_flash_gi16","play_flasher3_flash_hot","play_lsling_hot")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 70}", Array("powerup_cluster","play_flash_gi02","play_flash_gi18","play_flash_gi22","play_flash_gi14","play_flasher1_flash_magenta","play_rsling_magenta")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 71}", Array("powerup_moon","play_flash_gi07","play_flash_gi20","play_flash_gi17","play_flasher2_flash_yellow","play_lsling_yellow")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 72}", Array("powerup_proton","check_loser_message","check_winner_message5","play_flash_gi09","play_flash_gi19","play_flash_gi21","play_flash_gi12","play_flasher3_flash_cyan","play_rsling_cyan")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 73}", Array("powerup_shields","play_flash_gi04","play_flash_gi11","play_flash_gi13","play_flash_gi22","play_flash_giapron","play_flasher2_flash_blue","play_lsling_blue")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 74}", Array("powerup_timewarp","play_flash_gi01","play_flash_gi10","play_flash_gi18","play_flash_gi16","play_flash_gi14","play_flasher1_flash_white","play_rsling_white")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 75}", Array("powerup_saver","play_flash_gi06","play_flash_gi20","play_flash_gi17","play_flash_gi15","play_flasher2_flash_purple","play_lsling_purple")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 76}", Array("play_earth_hit_center","play_spotlight_off")
            '.Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 77}", Array("meteor1_knockdown","meteor1_flash_show","meteor1_blink_show","meteor1_explodes_white")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 78}", Array("meteor3_knockdown","meteor3_flash_show","meteor3_blink_show","meteor3_explodes_hot")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 79}", Array("meteor2_knockdown","meteor2_flash_show","meteor2_blink_show","meteor2_explodes_red")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 80}", Array("meteor4_knockdown","meteor4_flash_show","meteor4_blink_show","meteor4_explodes_white","meteor3_raise","display_last_scores")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 81}", Array("meteor1_knockdown","meteor1_flash_show","meteor1_blink_show","meteor1_explodes_hot","meteor2_raise")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 82}", Array("meteor3_knockdown","meteor3_flash_show","meteor3_blink_show","meteor3_explodes_red","meteor4_raise")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 83}", Array("meteor2_knockdown","meteor2_flash_show","meteor2_blink_show","meteor2_explodes_white","meteor1_raise")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 84}", Array("meteor4_knockdown","meteor4_flash_show","meteor4_blink_show","meteor4_explodes_hot","meteor3_raise")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 85}", Array("meteor1_knockdown","meteor1_flash_show","meteor1_blink_show","meteor1_explodes_red","meteor2_raise")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 86}", Array("meteor4_raise")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 87}", Array("play_proton_big_charge_fire","meteor1_raise")
            .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 88}", Array("check_loser_message","check_winner_message6","meteor3_raise")
            ' .Add "timer_post_game_show_tick{device.timers.post_game_show.ticks == 89}", Array("")
