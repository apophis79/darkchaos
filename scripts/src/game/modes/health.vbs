...
Sub CreateHealthMode
    ...
    With CreateGlfMode("health", 800)
        ...
        With .EventPlayer()
            ...
            .Add "check_add_health{current_player.health_value>8}", Array("health9_norm","health8_norm","health7_norm","health6_norm","health5_norm","health4_norm","health3_norm","health2_norm","health1_norm","restart_health")
