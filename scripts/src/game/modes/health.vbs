...
Sub CreateHealthMode
    ...
    With CreateGlfMode("health", 800)
        ...
        With .EventPlayer()
            ...
            .Add "check_add_health{current_player.health_value>8}", Array("health9_norm","health8_norm","health7_norm","health6_norm","health5_norm","health4_norm","health3_norm","health2_norm","health1_norm","health_norm","restart_health")
            .Add "check_add_health{current_player.health_value==8}", Array("health9_norm","health_norm","add_health")
            .Add "check_add_health{current_player.health_value==7}", Array("health8_norm","health_norm","add_health")
            .Add "check_add_health{current_player.health_value==6}", Array("health7_norm","health6_norm","health5_norm","health4_norm","health3_norm","health2_norm","health1_norm","health_norm","add_health")
            .Add "check_add_health{current_player.health_value==5}", Array("health6_warm","health_warm","add_health")
            .Add "check_add_health{current_player.health_value==4}", Array("health5_warm","health_warm","add_health")
            .Add "check_add_health{current_player.health_value==3}", Array("health4_warm","health_warm","health3_warm","health2_warm","health1_warm","health_warm","add_health")
            .Add "check_add_health{current_player.health_value==2}", Array("health3_crit","health_crit","add_health")
            .Add "check_add_health{current_player.health_value==1}", Array("health2_crit","health_crit","add_health")
            .Add "check_remove_health{current_player.health_value==9}", Array("health9_off","health_norm","remove_health")
            .Add "check_remove_health{current_player.health_value==8}", Array("health8_off","health9_off","health_norm","remove_health")
            .Add "check_remove_health{current_player.health_value==7}", Array("health7_off","health8_off","health9_off","health6_warm","health5_warm","health4_warm","health3_warm","health2_warm","health1_warm","remove_health","health_warm")
            .Add "check_remove_health{current_player.health_value==6}", Array("health6_off","health7_off","health8_off","health9_off","health_warm","remove_health")
            .Add "check_remove_health{current_player.health_value==5}", Array("health5_off","health6_off","health7_off","health8_off","health9_off","health_warm","remove_health")
            .Add "check_remove_health{current_player.health_value==4}", Array("health4_off","health5_off","health6_off","health7_off","health8_off","health9_off","health3_crit","health2_crit","health1_crit","health_crit","remove_health","play_voc_critically_low_health")
            .Add "check_remove_health{current_player.health_value==3}", Array("health3_off","health4_off","health5_off","health6_off","health7_off","health8_off","health9_off","health_crit","remove_health")
            .Add "check_remove_health{current_player.health_value==2}", Array("health2_off","health3_off","health4_off","health5_off","health6_off","health7_off","health8_off","health9_off","remove_health","health_crit","play_voc_imminent_shutdown")
            .Add "check_remove_health{current_player.health_value==1}", Array("health1_off","health2_off","health3_off","health4_off","health5_off","health6_off","health7_off","health8_off","health9_off","health_crit","remove_health","kill_flippers","turn_off_gi","meteor_wave_music_stop")
