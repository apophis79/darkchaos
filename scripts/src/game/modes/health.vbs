...
Sub CreateHealthMode
    ...
    With CreateGlfMode("health", 510)
        ...
        With .EventPlayer()
            ...
            .Add "s_Bumper1_acive", Array("check_add_health_bump")
            .Add "s_Bumper2_acive", Array("check_add_health_bump")
            .Add "s_Bumper3_acive", Array("check_add_health_bump")
            .Add "s_Bumper4_acive", Array("check_add_health_bump")
