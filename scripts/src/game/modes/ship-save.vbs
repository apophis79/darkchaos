...
Sub CreateShipSaveMode
    ...
    With CreateGlfMode("ship_save", 520)
        ...
        With .EventPlayer()
            ...
            .Add "mode_ship_save_started{current_player.shot_ship_charge3==2 and current_player.meteor_mb_shootagain_time =="&MeteorMBShootAgainTime&"}", Array("restart_ship_save")
            ...
            .Add "right_orbit_hit{current_player.shot_ship_charge1 == 2 and current_player.shot_ship_charge2 == 1}", Array("light_ship_charge2","ready_ship_charge3","play_sfx_LF")
            .Add "right_orbit_hit{current_player.shot_ship_charge2 == 2 and current_player.shot_ship_charge3 == 1}", Array("light_ship_charge3","play_sfx_LF")
