...
Sub CreateVictoryLapMode
    ...
    With CreateGlfMode("victory_lap", 9999)
        ...
        With .EventPlayer()
            ...
            'Handle shots
            .Add "s_TargetMystery1_active", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add "s_TargetMystery2_active", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add "s_TargetMystery3_active", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add "s_TargetMystery4_active", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add "s_TargetMystery5_active", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add MainShotNames(0)&"_hit", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add MainShotNames(1)&"_hit", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add MainShotNames(2)&"_hit", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add MainShotNames(3)&"_hit", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add MainShotNames(4)&"_hit", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add MainShotNames(5)&"_hit", Array("victory_fireworks_show","victory_flashers_show","score_250000")
            .Add MainShotNames(6)&"_hit", Array("victory_fireworks_show","victory_flashers_show","score_250000")
