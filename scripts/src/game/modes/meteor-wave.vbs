...
Sub CreateMeteorWaveMode
    ...
    With CreateGlfMode("meteor_wave", 1000)
        ...
        With .EventPlayer()
            ...
            .Add "mode_meteor_wave_started{current_player.shot_meteor_wave2 == 2 and current_player.shot_meteor_wave3 == 0}", Array("meteor_wave3_running","meteor_wave2_music_stop")
            .Add "mode_meteor_wave_started{current_player.shot_meteor_wave3 == 2 and current_player.shot_meteor_wave4 == 0}", Array("meteor_wave4_running","meteor_wave3_music_stop")
            .Add "mode_meteor_wave_started{current_player.shot_meteor_wave4 == 2 and current_player.shot_meteor_wave5 == 0}", Array("meteor_wave5_running","meteor_wave4_music_stop")
            .Add "mode_meteor_wave_started{current_player.shot_meteor_wave5 == 2 and current_player.shot_meteor_wave6 == 0}", Array("meteor_wave6_running","meteor_wave5_music_stop")
            .Add "mode_meteor_wave_started{current_player.shot_meteor_wave6 == 2 and current_player.shot_meteor_wave7 == 0}", Array("meteor_wave7_running","meteor_wave6_music_stop")
            .Add "mode_meteor_wave_started{current_player.shot_meteor_wave7 == 2 and current_player.shot_meteor_wave8 == 0}", Array("meteor_wave8_running","meteor_wave7_music_stop")
            .Add "mode_meteor_wave_started{current_player.shot_meteor_wave8 == 2 and current_player.shot_meteor_wave9 == 0}", Array("meteor_wave9_running","meteor_wave8_music_stop")
            'Successful center target hit, fire proton round if available
            .Add "s_TargetMystery3_active{current_player.shot_proton_round1 == 1 and current_player.shot_proton_round2 == 0}", Array("fire_proton_round1","proton_fired")
            .Add "s_TargetMystery3_active{current_player.shot_proton_round2 == 1 and current_player.shot_proton_round3 == 0}", Array("fire_proton_round2","proton_fired")
            .Add "s_TargetMystery3_active{current_player.shot_proton_round3 == 1 and current_player.shot_proton_round4 == 0}", Array("fire_proton_round3","proton_fired")
            ...
            .Add "check_meteor_wave.1{current_player.num_meteors_to_drop <= 0 and current_player.nuke_just_used == 0}", Array("meteor_wave_done")
        ...
        For x = 1 to 4   'for each meteor
            ...
            With .StateMachines("meteor"&x)
                ...
                With .Transitions()
                    .Source = Array("down")
                    .Target = "up_cool"
                    .Events = Array("timer_meteor"&x&"_tick{current_player.num_meteors_to_raise>0 and device.timers.meteor"&x&".ticks=="&MeteorDropTicks&"}")
                End With
                With .Transitions()
