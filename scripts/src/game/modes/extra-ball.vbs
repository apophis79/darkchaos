...
Sub CreateExtraBallMode
    ...
    With CreateGlfMode("extra_ball", 560)
        ...
        With .EventPlayer()
            ...
            .Add "balldevice_scoop_ball_entered{current_player.shot_eb_ready == 1 && current_player.wizard_mode_is_ready==0}", Array("play_eb_show","eb_achieved","score_50000") 'Collect the EB
