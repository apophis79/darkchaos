...
Sub CreateCombosMode
    ...
    With CreateGlfMode("combos", 530)
        ...
        With .EventPlayer()
            ...
            .Add "check_combos{current_player.combos_value==1}", Array("combos1_lit","add_combos","replay_sfx_combo","flash_combos","score_500")
            .Add "check_combos{current_player.combos_value==2}", Array("combos2_lit","add_combos","replay_sfx_combo","flash_combos","score_1000")
            .Add "check_combos{current_player.combos_value==3}", Array("combos3_lit","add_combos","replay_sfx_combo","flash_combos","score_2000")
            .Add "check_combos{current_player.combos_value==4}", Array("combos4_lit","add_combos","replay_sfx_combo","flash_combos","score_3000")
            .Add "check_combos{current_player.combos_value==5}", Array("combos5_lit","add_combos","replay_sfx_combo","flash_combos","score_4000")
            .Add "check_combos{current_player.combos_value==6}", Array("combos6_lit","add_combos","replay_sfx_combo","flash_combos","score_5000")
            .Add "check_combos{current_player.combos_value==7}", Array("combos7_lit","add_combos","replay_sfx_combo","flash_combos","score_10000")
            .Add "check_combos{current_player.combos_value==8}", Array("combos8_lit","check_combo_command_wizard","replay_sfx_combo","flash_combos","score_100000")
