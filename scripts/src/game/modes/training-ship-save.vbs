...
Sub CreateTrainingShipSaveMode
    ...
    With CreateGlfMode("training_ship_save",700)
        ...
        With .EventPlayer()
            ...
            .Add "right_orbit_hit{current_player.shot_training_ship_charge1 == 1 and current_player.shot_training_ship_charge2 == 0}", Array("light_ship_charge2","flash_gi","play_sfx_LS","score_300000")
            .Add "right_orbit_hit{current_player.shot_training_ship_charge2 == 1 and current_player.shot_training_ship_charge3 == 0}", Array("light_ship_charge3","play_sfx_LS","score_500000")
            .Add "light_ship_charge3", Array("training_achieved","play_sfx_super_jackpot")
            .Add "play_sfx_LS", Array("play_sfx_LS_during_training")
            'Stop the training
            .Add "training_achieved", Array("stop_training","training_stopped","badge_ship_save_on")
        ...
        With .SegmentDisplayPlayer()
            With .EventName("init_training")
                ...
                End With
                With .Display("pf")
                    .Text = "{device.timers.training_ship_save.ticks:0>2}"
                End With
            End With
        End With
