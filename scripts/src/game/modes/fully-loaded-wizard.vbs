...
Sub CreateFullyLoadedWizardMode
    ...
    With CreateGlfMode("fully_loaded_wizard", 2000)
        ...
        With .EventPlayer()
            ...
            'Phase 2 shots
            .Add "s_TargetMystery1_active{current_player.shot_flwiz_proton1 == 1 && current_player.wizard_fully_loaded_phase == 2}", Array("flwiz_add_ball","add_flwiz_phase2_shot","flwiz_phase2_proton1_hit","play_flwiz_proton_show","play_sfx_jackpot","score_300000")
            .Add "s_TargetMystery2_active{current_player.shot_flwiz_proton2 == 1 && current_player.wizard_fully_loaded_phase == 2}", Array("flwiz_add_ball","add_flwiz_phase2_shot","flwiz_phase2_proton2_hit","play_flwiz_proton_show","play_sfx_jackpot","score_300000")
            .Add "s_TargetMystery3_active{current_player.shot_flwiz_proton3 == 1 && current_player.wizard_fully_loaded_phase == 2}", Array("flwiz_add_ball","add_flwiz_phase2_shot","flwiz_phase2_proton3_hit","play_flwiz_proton_show","play_sfx_jackpot","score_300000")
            .Add "s_TargetMystery4_active{current_player.shot_flwiz_proton4 == 1 && current_player.wizard_fully_loaded_phase == 2}", Array("flwiz_add_ball","add_flwiz_phase2_shot","flwiz_phase2_proton4_hit","play_flwiz_proton_show","play_sfx_jackpot","score_300000")
            .Add "s_TargetMystery5_active{current_player.shot_flwiz_proton5 == 1 && current_player.wizard_fully_loaded_phase == 2}", Array("flwiz_add_ball","add_flwiz_phase2_shot","flwiz_phase2_proton5_hit","play_flwiz_proton_show","play_sfx_jackpot","score_300000")
            .Add         "shield_bank_hit{current_player.shot_flwiz_proton6 == 1 && current_player.wizard_fully_loaded_phase == 2}", Array("flwiz_add_ball","add_flwiz_phase2_shot","flwiz_phase2_proton6_hit","play_flwiz_proton_show","play_sfx_jackpot","score_300000")
            .Add "left_ramp_hit{current_player.shot_flwiz_cluster == 1 && current_player.wizard_fully_loaded_phase == 2}", Array("flwiz_add_ball","add_flwiz_phase2_shot","flwiz_phase2_cluster_hit","play_flwiz_cluster_show","play_sfx_jackpot","play_sfx_cluster_fired","score_300000")
            .Add "right_ramp_hit{current_player.shot_flwiz_moon == 1 && current_player.wizard_fully_loaded_phase == 2}", Array("flwiz_add_ball","add_flwiz_phase2_shot","flwiz_phase2_moon_hit","play_flwiz_moon_show","play_sfx_jackpot","play_sfx_launch","score_300000")
