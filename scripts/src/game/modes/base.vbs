...
Sub CreateBaseMode()
    ...
    With CreateGlfMode("base", 200)
        ...
        With .EventPlayer()
            ...
            'new ball
            .Add "mode_base_started", Array("stop_attract_mode","knockdown_meteors","check_base_restart","start_asteroid_motor","backglass_dark_on","backglass_chaos_on","backglass_wave_off","check_plunger", "display_player_scores")
            .Add "display_player_scores{machine.last_game_players>0}", Array("display_p1_score")
            .Add "display_player_scores{machine.last_game_players>1}", Array("display_p2_score")
            .Add "display_player_scores{machine.last_game_players>2}", Array("display_p3_score")
            .Add "display_player_scores{machine.last_game_players>3}", Array("display_p4_score")
