...
Sub CreateTrainingClusterBombMode
    ...
    With CreateGlfMode("training_cluster_bomb",700)
        ...
        With .EventPlayer()
            ...
            'successfull shot
            .Add "left_orbit_hit{current_player.shot_training_cluster_charge1 == 0}", Array("light_cluster_charge1","flash_gi","play_sfx_LS")
            .Add "left_orbit_hit{current_player.shot_training_cluster_charge1 == 1 && current_player.shot_training_cluster_charge2 == 0}", Array("light_cluster_charge2","flash_gi","play_sfx_LS")
            .Add "left_orbit_hit{current_player.shot_training_cluster_charge2 == 1 && current_player.shot_training_cluster_charge3 == 0}", Array("light_cluster_charge3","play_sfx_LS") ',"flash_gi")
