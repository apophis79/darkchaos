...
Function Glf_997(args)
	On Error Resume Next
	    Glf_997 = GetPlayerState("training_heal_achieved")=1
	If Err Then Glf_997 = False
End Function
Function Glf_998(args)
	On Error Resume Next
	    Glf_998 = GetPlayerState("training_cluster_bomb_achieved")=1
	If Err Then Glf_998 = False
End Function
Function Glf_999(args)
	On Error Resume Next
	    Glf_999 = GetPlayerState("training_proton_cannon_achieved")=1
	If Err Then Glf_999 = False
End Function
Function Glf_1000(args)
	On Error Resume Next
	    Glf_1000 = GetPlayerState("training_moon_missile_achieved")=1
	If Err Then Glf_1000 = False
End Function
Function Glf_1001(args)
	On Error Resume Next
	    Glf_1001 = GetPlayerState("training_ship_save_achieved")=1
	If Err Then Glf_1001 = False
End Function
Function Glf_1002(args)
	On Error Resume Next
	    Glf_1002 = GetPlayerState("training_shields_achieved")=1
...
Function Glf_1004(args)
	On Error Resume Next
	    Glf_1004 = glf_state_machines("training_select").GetValue("state")="heal"
	If Err Then Glf_1004 = False
End Function
Function Glf_1005(args)
	On Error Resume Next
	    Glf_1005 = glf_state_machines("training_select").GetValue("state")="cluster_bomb"
	If Err Then Glf_1005 = False
End Function
Function Glf_1006(args)
	On Error Resume Next
	    Glf_1006 = glf_state_machines("training_select").GetValue("state")="proton_cannon"
...
Function Glf_1009(args)
	On Error Resume Next
	    Glf_1009 = glf_state_machines("training_select").GetValue("state")="shields"
	If Err Then Glf_1009 = False
End Function
Function Glf_1010(args)
	On Error Resume Next
	    Glf_1010 = glf_state_machines("training_select").GetValue("state")="skip"
	If Err Then Glf_1010 = False
End Function
Function Glf_1011(args)
	On Error Resume Next
	    Glf_1011 = glf_ball_devices("moon_lock").GetValue("balls") > GetPlayerState("moon_launch_locked_balls")
...
Function Glf_1141(args)
	On Error Resume Next
	    Glf_1141 = GetPlayerState("meteor_wave_running") = 1
...
Function Glf_1154(args)
	On Error Resume Next
	    Glf_1154 = GetPlayerState("shot_mw_health")=1
...
Function Glf_1270(args)
	On Error Resume Next
	    Glf_1270 = GetPlayerState("fwwiz_add_ball_ready") = 1
...
Function Glf_1272(args)
	On Error Resume Next
	    Glf_1272 = GetPlayerState("fwwiz_add_ball_ready") = 2
...
Function Glf_1315(args)
	On Error Resume Next
	    Glf_1315 = GetPlayerState("wizard_final_hit_count") > 1
	If Err Then Glf_1315 = False
End Function
Function Glf_1316(args)
	On Error Resume Next
	    Glf_1316 = GetPlayerState("wizard_final_hit_count") > 1
	If Err Then Glf_1316 = False
End Function
Function Glf_1317(args)
	On Error Resume Next
	    Glf_1317 = GetPlayerState("wizard_final_hit_count") > 1
	If Err Then Glf_1317 = False
End Function
Function Glf_1318(args)
	On Error Resume Next
	    Glf_1318 = GetPlayerState("wizard_final_hit_count") > 1
...
Function Glf_1405(args)
	On Error Resume Next
	    Glf_1405 = GetPlayerState("victory_lap_running") = 0
...
glf_funcRefMap.Add "mode_training_select_started{current_player.training_heal_achieved==1}", "Glf_997"
glf_funcRefMap.Add "mode_training_select_started{current_player.training_cluster_bomb_achieved==1}", "Glf_998"
glf_funcRefMap.Add "mode_training_select_started{current_player.training_proton_cannon_achieved==1}", "Glf_999"
...
glf_funcRefMap.Add "make_selection{device.state_machines.training_select.state==""moon_missile""}", "Glf_1007"
glf_funcRefMap.Add "make_selection{device.state_machines.training_select.state==""ship_save""}", "Glf_1008"
glf_funcRefMap.Add "make_selection{device.state_machines.training_select.state==""shields""}", "Glf_1009"
glf_funcRefMap.Add "make_selection{device.state_machines.training_select.state==""skip""}", "Glf_1010"
glf_funcRefMap.Add "balldevice_moon_lock_ball_enter{device.ball_devices.moon_lock.balls > current_player.moon_launch_locked_balls}", "Glf_1011"
glf_funcRefMap.Add "check_ts_heal{current_player.ts_last_move==""left"" and current_player.training_heal_achieved==1}", "Glf_1012"
glf_funcRefMap.Add "check_ts_heal{current_player.ts_last_move==""right"" and current_player.training_heal_achieved==1}", "Glf_1013"
glf_funcRefMap.Add "check_ts_cluster_bomb{current_player.ts_last_move==""left"" and current_player.training_cluster_bomb_achieved==1}", "Glf_1014"
glf_funcRefMap.Add "check_ts_cluster_bomb{current_player.ts_last_move==""right"" and current_player.training_cluster_bomb_achieved==1}", "Glf_1015"
glf_funcRefMap.Add "check_ts_proton_cannon{current_player.ts_last_move==""left"" and current_player.training_proton_cannon_achieved==1}", "Glf_1016"
glf_funcRefMap.Add "check_ts_proton_cannon{current_player.ts_last_move==""right"" and current_player.training_proton_cannon_achieved==1}", "Glf_1017"
glf_funcRefMap.Add "check_ts_moon_missile{current_player.ts_last_move==""left"" and current_player.training_moon_missile_achieved==1}", "Glf_1018"
glf_funcRefMap.Add "check_ts_moon_missile{current_player.ts_last_move==""right"" and current_player.training_moon_missile_achieved==1}", "Glf_1019"
glf_funcRefMap.Add "check_ts_ship_save{current_player.ts_last_move==""left"" and current_player.training_ship_save_achieved==1}", "Glf_1020"
