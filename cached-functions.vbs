...
glf_funcRefMap.Add "init_player_scores{machine.last_game_players>0}", "Glf_646"
glf_funcRefMap.Add "init_player_scores{machine.last_game_players>1}", "Glf_647"
glf_funcRefMap.Add "init_player_scores{machine.last_game_players>2}", "Glf_648"
glf_funcRefMap.Add "init_player_scores{machine.last_game_players>3}", "Glf_649"
